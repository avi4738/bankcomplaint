		...
		<div class="navbar-inner">
			<div class="container">
				<a class="btn btn-navbar" data-toggle="collapse"
					...
					class="icon-reorder shaded"></i></a><a class="brand" href="home.jsp" >Funds
					Bank </a>
    ...
    <label class="onoffswitch-label" for="myonoffswitch">
        ...
        <span class="onoffswitch-switch"></span>
						...
						<li class="nav-user dropdown"><a href="#"
							class="dropdown-toggle" data-toggle="dropdown"> Hello <%=application.getAttribute("name")%> <img
				...
				<div class="span3">
					...
					<div class="content">
						<div class="btn-controls">
							<div class="btn-box-row row-fluid " align="center" style="font-size: x-large;"><!-- shadow -->
							
								<span>Your complaint has been registered.</span><br><br>
								<span>Your complaint ID is <%=application.getAttribute("complaintId")%><b></b></span><br><br><br><br> 
								<span><a href="raise1" style="color: #ffffff">Raise Complaint</a></span>
								<span><a href="checkStatus1" style="margin-left: 250px;color: #ffffff">Check Status</a></span>
							</div>
