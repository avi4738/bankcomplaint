				...
				<div class="span3">
					<div class="sidebar">
						<ul class="widget widget-menu unstyled">
							...
							<li><a href="#"><i class="menu-icon icon-bullhorn"></i><i
									id="info" class="fa fa-info-circle pull-right info"
									data-toggle="tooltip"
									title="This section shows your allowances."></i>Allowances</a></li>
							<li><a href="adminComplaint"><i
									class="menu-icon icon-inbox"> </i>Complaints</a></li>
						</ul>
